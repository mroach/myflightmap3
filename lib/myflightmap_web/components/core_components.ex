defmodule MyflightmapWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MyflightmapWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MyflightmapWeb.Gettext, "errors", msg, opts)
    end
  end
