defmodule Myflightmap.Travel.WorldmateTripImporterTest do
  ...
  test "import/1" do
    ...
    insert(:airport, iata_code: "FRA", coordinates: %Point{x: 50.033333, y: 8.570556}, timezone: "Europe/Berlin")
    insert(:airport, iata_code: "JFK", coordinates: %Point{x: 40.63980103, y: -73.77890015}, timezone: "America/New_York")
